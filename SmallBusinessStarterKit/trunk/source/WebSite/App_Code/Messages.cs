...
public class Messages
{
    ...
    public static string CategoryRequiredAttributesMissing =
        "Some of the required attributes of Category are NULL in the Category table";
    ...
    public static string ItemRequiredAttributesMissing =
        "Some of the required attributes of Item are NULL in the Items table";
    ...
    public static string NewsItemRequiredAttributesMissing =
        "Some of the required attributes of NewsItem are NULL in the News table";
    ...
    public static string PersonRequiredAttributesMissing =
    ...
    public static string TestimonialsProviderInstantiationError =
        "Testimonials default provider could not be instantiated";

    public static string TestimonialsRequiredAttributesMissing =
        "Some of the required fields of Testimonial are NULL in the Testimonials table";
