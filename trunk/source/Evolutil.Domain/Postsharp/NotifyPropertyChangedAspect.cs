...
namespace Evolutil.Domain.Postsharp
{
    ...
    [Serializable]
    public sealed class NotifyPropertyChangedAspect : CompoundAspect
    {
        [NonSerialized]
        ...
        /// </summary>
        [Serializable]
        internal sealed class OnPropertySetSubAspect : OnMethodBoundaryAspect
        {
            ...
            /// <param name="parent">Parent <see cref="NotifyPropertyChangedAspect"/>.</param>
            public OnPropertySetSubAspect(string propertyName, NotifyPropertyChangedAspect parent)
            {
            ...
            public override void OnSuccess(MethodExecutionEventArgs eventArgs)
            {
                ...
                var implementation = (NotifyPropertyChangedImplementation)
        ...
        /// </summary>
        [Serializable]
        internal sealed class AddNotifyPropertyChangedInterfaceSubAspect : CompositionAspect
        {
            /// <summary>
