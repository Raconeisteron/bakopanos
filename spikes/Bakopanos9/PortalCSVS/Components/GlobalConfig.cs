...
namespace ASPNET.StarterKit.Portal
{
    ...
    public class GlobalConfig : IGlobalConfig,
                                IPortalConfig, ITabsConfig, IModulesConfig, IModuleDefConfig
    {
        private readonly string _configFile;
        private IPortalDB _portalDb;
        public GlobalConfig([Dependency("ConfigFile")] string configFile, IPortalDB portalDb)
        {
        ...
        public void DeleteTab(int tabId)
        {
            ...
            {
                _portalDb.DeleteModule(moduleRow.ModuleId);
            }
