...
namespace ASPNET.StarterKit.Portal
{
    public partial class DiscussDetails : PortalPage<DiscussDetails>
    {
        ...
        [Dependency]
        public IDiscussionDB DiscussionDB { private get; set; }
        ...
        protected void UpdateBtn_Click(Object sender, EventArgs e)
        {
            ...
            itemId = DiscussionDB.AddMessage(moduleId, itemId, User.Identity.Name, Server.HtmlEncode(TitleField.Text), Server.HtmlEncode(BodyField.Text));
