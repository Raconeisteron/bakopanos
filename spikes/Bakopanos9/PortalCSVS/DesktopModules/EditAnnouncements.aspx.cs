        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack == false)
            {
                if (itemId != 0)
                {
                    ...
                    IDataReader dr = AnnouncementsDB.GetSingleAnnouncement(itemId);
        ...
        protected void UpdateBtn_Click(Object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                if (itemId == 0)
                {
                    ...
                    AnnouncementsDB.AddAnnouncement(moduleId, itemId, Context.User.Identity.Name, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, MoreLinkField.Text,
                                                   MobileMoreField.Text);
                }
                else
                {
                    // Update the announcement within the Announcements table
                    AnnouncementsDB.UpdateAnnouncement(moduleId, itemId, Context.User.Identity.Name, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, MoreLinkField.Text,
                                                      MobileMoreField.Text);
                }
