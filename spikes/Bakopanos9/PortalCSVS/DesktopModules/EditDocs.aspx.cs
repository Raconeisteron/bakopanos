...
namespace ASPNET.StarterKit.Portal
{
    public partial class EditDocs : PortalPage<EditDocs>
    {
        ...
        [Dependency]
        public IDocumentDB DocumentDB { private get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack == false)
            {
                if (itemId != 0)
                {
                    ...
                    IDataReader dr = DocumentDB.GetSingleDocument(itemId);
        ...
        protected void UpdateBtn_Click(Object sender, EventArgs e)
        {
            ...
            {                
                ...
                if (storeInDatabase.Checked && (FileUpload.PostedFile != null))
                {
                    ...
                    DocumentDB.UpdateDocument(moduleId, itemId, Context.User.Identity.Name, NameField.Text, PathField.Text, CategoryField.Text, content, length, contentType);
                }
                else
                {
                    ...
                    DocumentDB.UpdateDocument(moduleId, itemId, Context.User.Identity.Name, NameField.Text, PathField.Text, CategoryField.Text, new byte[0], 0, "");
                }
