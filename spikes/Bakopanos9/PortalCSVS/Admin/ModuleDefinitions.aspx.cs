...
{
    public partial class ModuleDefinitions : PortalPage<Page>
    {
        private int defId = -1;
        private int tabId;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack == false)
            {
                ...
                else
                {
                    ...
                    SiteConfiguration.ModuleDefinitionRow modDefRow = ModuleDefConfig.GetSingleModuleDefinition(defId);
        ...
        protected void UpdateBtn_Click(Object sender, EventArgs e)
        {
            ...
            {                
                if (defId == -1)
                {
                    ...
                    ModuleDefConfig.AddModuleDefinition(portalSettings.PortalId, FriendlyName.Text, DesktopSrc.Text, MobileSrc.Text);
                }
                else
                {
