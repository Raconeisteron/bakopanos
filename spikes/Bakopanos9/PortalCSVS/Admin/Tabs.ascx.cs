    ...
    public partial class Tabs : PortalModuleControl<Tabs>
    {
        ...
        protected void UpDown_Click(Object sender, ImageClickEventArgs e)
        {
            ...
            if (tabList.SelectedIndex != -1)
            {
                ...
                Response.Redirect("~/DesktopDefault.aspx?tabindex=" + (portalTabs.Count - 1) + "&tabid=" + tabId);
            }
        }
        ...
        protected void AddTab_Click(Object Sender, EventArgs e)
        {
            ...
            t.TabId = TabsConfig.AddTab(portalSettings.PortalId, t.TabName, t.TabOrder);

            // reload the _portalSettings from the database
            HttpContext.Current.Items["PortalSettings"] = new PortalSettings(portalSettings.PortalId, t.TabId, GlobalConfig);
